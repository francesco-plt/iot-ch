...
#line 177
{
  ...
  if (len != sizeof(ch4_msg_t ) && TOS_NODE_ID == 2) {
      sim_log_error(163U, "CH4App", "CH4App: [Mote %d] Received packet of unknown size %hhu.\n", TOS_NODE_ID, len);
    }


  if (__nesc_ntoh_uint8(m->type.nxdata) != 1 && TOS_NODE_ID == 2) {
      sim_log_error(164U, "CH4App", "CH4App: [Mote %d] Received packet of unknown type %hhu.\n", TOS_NODE_ID, __nesc_ntoh_uint8(m->type.nxdata));
      return buf;
    }
  if (__nesc_ntoh_uint8(m->type.nxdata) == 1) {
      sim_log_debug(165U, "CH4App", "CH4App [Mote %d]: REQ received\n", TOS_NODE_ID);
    }
  if (__nesc_ntoh_uint8(m->type.nxdata) == 2) {
      sim_log_debug(166U, "CH4App", "CH4App [Mote %d]: RESP received\n", TOS_NODE_ID);
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7695298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7695298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7695298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7695930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7695930, msg, payload, len);
#line 78
...
#line 102
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(152U, "radio", "[%d] Radio on on node %d!\n", Ch4C$LocalTime$get(), TOS_NODE_ID);
      if (TOS_NODE_ID == 1) {
          sim_log_debug(153U, "timer", "timer: [Mote %d] starting timer...\n", TOS_NODE_ID);
          Ch4C$MilliTimer$startPeriodic(TIMER_PERIOD_MILLI);
        }
    }
  else {
      sim_log_error(154U, "boot", "boot: Error starting the radio.\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76a48b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76a48b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb738fa98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb738fa98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb738fa98, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb738c498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb738c498, addr, msg, len);
#line 80
...
#line 52
      ...
      if (Ch4C$AMSend$send(Ch4C$mote2_id[sim_node()], &Ch4C$packet[sim_node()], sizeof(ch4_msg_t )) == SUCCESS) {
          sim_log_debug(150U, "CH4App", "CH4App: [Mote %d] REQ sent\n", TOS_NODE_ID);
...
#line 122
{
  ...
  sim_log_debug(155U, "timer", "timer: [%d] timer fired, counter now is %hhu.\n\n", Ch4C$LocalTime$get(), Ch4C$counter[sim_node()]);
...
#line 214
  sim_log_debug(167U, "CH4App", "CH4App: [Mote %d] Read done.\n", TOS_NODE_ID);
  if (m == (void *)0) {
      sim_log_debug(168U, "CH4App", "CH4App: readDone - error getting the payload.\n");
      return;
    }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73e53a8){
#line 83
  switch (arg_0xb73e53a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73e53a8);
#line 83
      break;
#line 83
    }
...
#line 92
{
  ...
  sim_log_debug(151U, "boot", "boot: [%d] Application booted.\n", Ch4C$LocalTime$get());
  Ch4C$AMControl$start();
}
...
#line 137
{
  ...
  if (&Ch4C$packet[sim_node()] == buf) {
      ...
      ch4_msg_t *m = (ch4_msg_t *)Ch4C$Packet$getPayload(&buf, sizeof(ch4_msg_t ));

#line 144
      Ch4C$locked[sim_node()] = FALSE;
      if (__nesc_ntoh_uint8(m->type.nxdata) == 1) {
          sim_log_debug(156U, "CH4App", "CH4App [Mote %d]: REQ packet sent.\n", TOS_NODE_ID);
        }
      else {
#line 147
        if (__nesc_ntoh_uint8(m->type.nxdata) == 2) {
            sim_log_debug(157U, "CH4App", "CH4App [Mote %d]: RESP packet sent.\n", TOS_NODE_ID);
          }
        }
    }
  else 
#line 150
    {
      sim_log_error(158U, "CH4App", "CH4App: packet not sent.\n");
    }
  ...
  if (Ch4C$PacketAcknowledgements$wasAcked(buf)) {
      ...
      if (TOS_NODE_ID == 1) {
          ...
          sim_log_debug(159U, "CH4App", "CH4App: [Mote %d] REQ-ACK received, X is now %hhu\n", TOS_NODE_ID, Ch4C$X[sim_node()]);

          if (Ch4C$X[sim_node()] == 0) {
              sim_log_debug(160U, "CH4App", "CH4App: Stopping timer.\n");
              sim_log_debug(161U, "timer", "timer: timer stopped.\n");
...
#line 167
    {
      ...
      sim_log_error(162U, "CH4App", "CH4App: ACK not received. Waiting for next timer call...\n");
    }
}
