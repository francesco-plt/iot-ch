...
#line 177
{
  ...
  sim_log_debug(162U, "CH4App", "CH4App: [node %d] Received packet of length %hhu.\n", len, TOS_NODE_ID);


  if (len != sizeof(resp_msg_t )) {
      sim_log_error(163U, "CH4App", "CH4App: Received packet of wrong size.\n");
      return (void *)0;
    }
  else 
#line 189
    {
      ...
      if (__nesc_ntoh_uint8(m->type.nxdata) != 1) {
          sim_log_debug(164U, "CH4App", "CH4App: Received packet of unknown type %hhu.\n", __nesc_ntoh_uint8(m->type.nxdata));
          return (void *)0;
        }
      sim_log_debug(165U, "CH4App", "CH4App [Mote %d]:Request received\n", TOS_NODE_ID);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb763dac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb763dac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb763dac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb763b178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb763b178, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb763d108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb763d108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7338a98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7338a98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7338a98, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7335498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7335498, addr, msg, len);
#line 80
...
#line 57
    {
      req_msg_t *m = (req_msg_t *)Ch4C$Packet$getPayload(&Ch4C$packet[sim_node()], sizeof(req_msg_t ));
...
#line 59
      ...
      if (Ch4C$AMSend$send(Ch4C$mote1_id[sim_node()], &Ch4C$packet[sim_node()], sizeof(req_msg_t )) == SUCCESS) {
...
#line 212
{
  ...
  resp_msg_t *m = (resp_msg_t *)Ch4C$Packet$getPayload(&Ch4C$packet[sim_node()], sizeof(resp_msg_t ));

#line 216
  sim_log_debug(166U, "CH4App", "CH4App: [Mote %d] Read done.\n", TOS_NODE_ID);
  if (m == (void *)0) {
      sim_log_debug(167U, "CH4App", "CH4App: readDone - error getting the payload.\n");
      return;
    }
  __nesc_hton_uint8(m->type.nxdata, 2);
  __nesc_hton_uint8(m->counter_cpy.nxdata, Ch4C$counter[sim_node()]);
  __nesc_hton_uint8(m->value.nxdata, data);

  sim_log_debug(168U, "CH4App", "CH4App: packet content - type %hhu, counter %hhu, data %hhu.\n", __nesc_ntoh_uint8(m->type.nxdata), __nesc_ntoh_uint8(m->counter_cpy.nxdata), __nesc_ntoh_uint8(m->value.nxdata));


  sim_log_debug(169U, "CH4App", "CH4App [Mote %d]: Sending response.\n", TOS_NODE_ID);
  Ch4C$AMSend$send(Ch4C$mote2_id[sim_node()], &Ch4C$packet[sim_node()], sizeof(resp_msg_t ));
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb738e3a8){
#line 83
  switch (arg_0xb738e3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb738e3a8);
#line 83
      break;
#line 83
    }
...
#line 141
{
  ...
  sim_log_debug(155U, "radio", "radio: [%d] Sending done. ACK RESULT: %d\n", Ch4C$LocalTime$get(), Ch4C$PacketAcknowledgements$wasAcked(buf));
  if (TOS_NODE_ID != 1) {
      return;
    }
  ...
  if (&Ch4C$packet[sim_node()] == buf) {
      ...
      sim_log_debug(156U, "CH4App", "CH4App [Mote %d]: [%hhu] REQ packet sent.\n", TOS_NODE_ID, Ch4C$counter[sim_node()]);
    }
  else 
#line 152
    {
      sim_log_error(157U, "CH4App", "CH4App: packet not sent.\n");
    }


  if (Ch4C$PacketAcknowledgements$wasAcked(buf) == TRUE) {

      sim_log_debug(158U, "CH4App", "CH4App: ACK received.\n");

      if (Ch4C$counter[sim_node()] == Ch4C$Y[sim_node()]) {
          sim_log_debug(159U, "CH4App", "CH4App: %hhu-th iteration reached.\nStopping timer.\n", Ch4C$counter[sim_node()]);
          sim_log_debug(160U, "timer", "timer: timer stopped.\n");
...
#line 166
    {
      ...
      sim_log_error(161U, "CH4App", "CH4App: ACK not received. Waiting for next timer call...\n");
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module Ch4C */
  if (!strcmp(varname, "Ch4C$Y"))
  {
    *addr = (uintptr_t)&Ch4C$Y[__nesc_mote];
    *size = sizeof(Ch4C$Y[__nesc_mote]);
    return 0;
  }
