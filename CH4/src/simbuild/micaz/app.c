...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7be7458, const void *arg_0xb7be75f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b988c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a42840), 
int (*key_eq_fn)(void *arg_0xb7a42c88, void *arg_0xb7a42e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79119b8, int arg_0xb7911b10);
static double RandomUniform(void );
...
typedef nx_struct ch4_msg {
  ...
  nx_uint8_t counter;
  nx_uint8_t value;
} __attribute__((packed)) ch4_msg_t;
...
typedef TMilli Ch4C$LocalTime$precision_tag;
...
typedef TMilli /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint16_t /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void Ch4C$AMControl$startDone(error_t error);
#line 138
static void Ch4C$AMControl$stopDone(error_t error);
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t Ch4C$AMControl$start(void );
...
uint8_t len);
# 61 "/opt/tinyos-main-2.1.2/tos/lib/timer/LocalTime.nc"
static uint32_t Ch4C$LocalTime$get(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
...
uint8_t Ch4C$counter_cpy[1000];
am_addr_t Ch4C$mote2_id[1000];
am_addr_t Ch4C$mote1_id[1000];
...
static inline void Ch4C$AMControl$startDone(error_t err);
#line 117
static inline void Ch4C$AMControl$stopDone(error_t err);
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}
...
#line 55
  __nesc_result = /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 168
{
  ...
  if (len != sizeof(ch4_msg_t )) {
      sim_log_error(161U, "CH4App", "CH4App: [Mote %d] Received packet of unknown size %hhu.\n", TOS_NODE_ID, len);
    }


  if (__nesc_ntoh_uint8(m->type.nxdata) != 1) {
      sim_log_error(162U, "CH4App", "CH4App: [Mote %d] Received packet of unknown type %hhu.\n", TOS_NODE_ID, __nesc_ntoh_uint8(m->type.nxdata));
      return buf;
    }
  sim_log_debug(163U, "CH4App", "CH4App [Mote %d]: Request received\n", TOS_NODE_ID);
  Ch4C$counter_cpy[sim_node()] = __nesc_ntoh_uint8(m->counter.nxdata);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76b2298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76b2298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76b2298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76b2930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76b2930, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Ch4C$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 61 "/opt/tinyos-main-2.1.2/tos/lib/timer/LocalTime.nc"
inline static uint32_t Ch4C$LocalTime$get(void ){
#line 61
  unsigned int __nesc_result;
#line 61
...
#line 102
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(151U, "radio", "[%d] Radio on on node %d!\n", Ch4C$LocalTime$get(), TOS_NODE_ID);
      if (TOS_NODE_ID == 1) {
          sim_log_debug(152U, "timer", "timer: [Mote %d] starting timer...\n", TOS_NODE_ID);
          Ch4C$MilliTimer$startPeriodic(TIMER_PERIOD_MILLI);
        }
    }
  else {
      sim_log_error(153U, "boot", "boot: Error starting the radio.\n");
      Ch4C$AMControl$start();
    }
}
...
#line 113
  Ch4C$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76c18b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76c18b0, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
...
#line 65
{
  /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73b2a98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73b2a98) {
#line 100
    case 0U:
#line 100
      /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73b2a98, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb786d650){
#line 75
  switch (arg_0xb786d650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb786d650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73af498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73af498, addr, msg, len);
#line 80
...
#line 80
  __nesc_result = /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 45
{
  ...
  if (Ch4C$locked[sim_node()]) {
      sim_log_error(148U, "CH4App", "CH4App:Cannot send request, radio unavalaible\n");
      return;
    }
  else 
#line 50
    {
      ch4_msg_t *m = (ch4_msg_t *)Ch4C$Packet$getPayload(&Ch4C$packet[sim_node()], sizeof(ch4_msg_t ));

#line 52
      if (m == (void *)0) {
          sim_log_error(149U, "CH4App", "CH4App [Mote %d]: Packet.getPayload failed", TOS_NODE_ID);
        }
      ...
      __nesc_hton_uint8(m->counter.nxdata, Ch4C$counter[sim_node()]);
      ...
      if (Ch4C$AMSend$send(Ch4C$mote2_id[sim_node()], &Ch4C$packet[sim_node()], sizeof(ch4_msg_t )) == SUCCESS) {
...
#line 122
{
  ...
  sim_log_debug(154U, "timer", "timer: [%d] timer fired, counter now is %hhu.\n\n", Ch4C$LocalTime$get(), Ch4C$counter[sim_node()]);
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 199
  sim_log_debug(164U, "CH4App", "CH4App: [Mote %d] Read done.\n", TOS_NODE_ID);
  if (m == (void *)0) {
      sim_log_debug(165U, "CH4App", "CH4App: readDone - error getting the payload.\n");
      return;
    }

  __nesc_hton_uint8(m->type.nxdata, 2);
  __nesc_hton_uint8(m->counter.nxdata, Ch4C$counter_cpy[sim_node()]);
  __nesc_hton_uint8(m->value.nxdata, data);
  sim_log_debug(166U, "CH4App", "CH4App: [Mote %d] packet content:\n\ttype: %hhu\n\tcounter: %hhu\n\tdata: %hhu\n", TOS_NODE_ID, __nesc_ntoh_uint8(m->type.nxdata), __nesc_ntoh_uint8(m->counter.nxdata), __nesc_ntoh_uint8(m->value.nxdata));


  sim_log_debug(167U, "CH4App", "CH4App [Mote %d]: Sending response.\n", TOS_NODE_ID);
  Ch4C$PacketAcknowledgements$requestAck(&Ch4C$packet[sim_node()]);
  if (Ch4C$AMSend$send(Ch4C$mote1_id[sim_node()], &Ch4C$packet[sim_node()], sizeof(ch4_msg_t )) == SUCCESS) {
      Ch4C$locked[sim_node()] = TRUE;
    }
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
...
#line 24
{
  /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74083a8){
#line 83
  switch (arg_0xb74083a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      /*AppCh4C.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74083a8);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 92
{
  ...
  sim_log_debug(150U, "boot", "boot: [%d] Application booted.\n", Ch4C$LocalTime$get());
  Ch4C$AMControl$start();
}
...
#line 137
{
  ...
  if (&Ch4C$packet[sim_node()] == buf) {
      Ch4C$locked[sim_node()] = FALSE;
      sim_log_debug(155U, "CH4App", "CH4App [Mote %d]: [%hhu] REQ packet sent.\n", TOS_NODE_ID, Ch4C$counter[sim_node()]);
    }
  else 
#line 143
    {
      sim_log_error(156U, "CH4App", "CH4App: packet not sent.\n");
    }


  if (Ch4C$PacketAcknowledgements$wasAcked(buf)) {

      Ch4C$X[sim_node()] = Ch4C$X[sim_node()] - 1;
      sim_log_debug(157U, "CH4App", "CH4App: ACK received, X is now %hhu\n", Ch4C$X[sim_node()]);

      if (Ch4C$X[sim_node()] == 0) {
          sim_log_debug(158U, "CH4App", "CH4App: Stopping timer.\n");
          sim_log_debug(159U, "timer", "timer: timer stopped.\n");
...
#line 158
    {
      ...
      sim_log_error(160U, "CH4App", "CH4App: ACK not received. Waiting for next timer call...\n");
    }
}
...
#line 55
{
  /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*AppCh4C.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Ch4C$counter_cpy"))
  {
    *addr = (uintptr_t)&Ch4C$counter_cpy[__nesc_mote];
    *size = sizeof(Ch4C$counter_cpy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Ch4C$mote2_id"))
  {
    *addr = (uintptr_t)&Ch4C$mote2_id[__nesc_mote];
    *size = sizeof(Ch4C$mote2_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Ch4C$mote1_id"))
  {
    *addr = (uintptr_t)&Ch4C$mote1_id[__nesc_mote];
    *size = sizeof(Ch4C$mote1_id[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module Ch4C */
  Ch4C$X[__nesc_mote] = 2;
  Ch4C$counter[__nesc_mote] = 0;
  memset((void *)&Ch4C$counter_cpy[__nesc_mote], 0, sizeof Ch4C$counter_cpy[__nesc_mote]);
  Ch4C$mote2_id[__nesc_mote] = 2;
  Ch4C$mote1_id[__nesc_mote] = 1;
